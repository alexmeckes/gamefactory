  ...
  <script>
    (function () {
      ...
      function promptDetails(manifest) {
        if(!manifest||!Array.isArray(manifest.layers))return "";var provider=(manifest.providerContext&&manifest.providerContext.modelProvider)||manifest.provider||"unreported";var model=(manifest.providerContext&&manifest.providerContext.actualModel)||manifest.model||"provider default";
        ...
        return '<div class="section-label">Prompt &amp; context</div><div class="artifact"><span>Adapter</span><span class="artifact-kind">'+esc(manifest.adapter||"unreported")+'</span></div><div class="artifact"><span>Provider / model</span><span class="artifact-kind">'+esc(provider+' / '+model)+'</span></div>'+layers;
      }
