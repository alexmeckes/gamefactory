...
func _draw() -> void:
	...
	draw_string(ThemeDB.fallback_font, Vector2(154, 117), "THE LONG COMPANY", HORIZONTAL_ALIGNMENT_LEFT, -1, 20, Color("cbd5e1"))
	draw_string(ThemeDB.fallback_font, Vector2(107, 151), "The factory must prove the risk and return loop.", HORIZONTAL_ALIGNMENT_LEFT, -1, 12, Color("8290a6"))
