...
func _draw() -> void:
	...
	draw_string(ThemeDB.fallback_font, Vector2(150, 117), "UNFORMED GAME", HORIZONTAL_ALIGNMENT_LEFT, -1, 20, Color("cbd5e1"))
	draw_string(ThemeDB.fallback_font, Vector2(109, 151), "The factory must invent and prove the interaction.", HORIZONTAL_ALIGNMENT_LEFT, -1, 12, Color("8290a6"))
