...
func run_scenario() -> void:
	...
	if subject.has_method("factory_collect"):
		...
		violations.append({"code":"emberline.factory_hooks", "message":"Missing factory_collect.", "severity":"error"})
	var artifacts: Array = [{"kind":"telemetry", "path":telemetry_path, "mediaType":"application/x-ndjson", "label":"Emberline deterministic telemetry"}]
	write_json(output_dir.path_join("result.json"), {
